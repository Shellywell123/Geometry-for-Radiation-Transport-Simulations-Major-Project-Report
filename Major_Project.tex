...
\label{novar}
\end{figure}
\noindent The dimensions of the spheres used in fig.\ref{novar} were set to a minimum radius of 1 micron and a maximum radius of 10 mm. 
\\\\
It was then proposed that the radius of thickness could be scaled with respect to the stopping distance of the material it is travelling through, in order to eliminate material as a variable. The radius of thickness $\Delta R$ can be seen depicted in fig.\ref{deltar}, where $\Delta R = R_{Max} - R_{Min}$.
