...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.9]{Images//Materials//Materials_Time_dists.pdf}
\caption[width=\columnwidth]{Meshing Development for Tubs (Solid \& Mesh View)}
\label{tubspic}
\end{figure}
...
\endgroup
\onecolumn
\section{Quadratic Parameters for polygon count plots}{appp1}
