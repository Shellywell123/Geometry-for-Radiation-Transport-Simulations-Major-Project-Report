...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=1\textwidth]{Images//CPU//Total_plot.pdf}
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=1\textwidth]{{Images//CPU//Total_Plot_no_secondaries1.pdf}}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.7]{Images//CAD_Screw//boltcount.pdf}
...
\bibitem{cancer}
	Author links open overlay panelElaine M.Zeman et al.\\
