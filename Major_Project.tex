...
\label{stop}
stopping power is ../\\
The stopping power is calculated by extracting values from the Geant4 data lists and then interpolating or extrapolating between them, as the stopping power is a function of the energy of the incident particle as well as the material. If both the stopping power of a material and the energy of the particle interacting with it, a stopping distance can be calculated. The Geant4 TestEm0 example outputs the stopping power and distances for a given material and particle energy. 
\\
The extracted stopping powers match with values found in other studies to
\\
