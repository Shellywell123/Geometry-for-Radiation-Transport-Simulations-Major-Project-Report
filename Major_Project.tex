...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.4]{Images//Booleans//Boolean.png}
...
\caption[width=\columnwidth]{BDSIM screenshot of 200 1.3 Gev protons interacting with a sphere, generated with the new meshing using a stack \& slice of 10 \& 10.}
\label{cylmeshin}
\end{figure}
\newpage
